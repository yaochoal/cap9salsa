...
public class Cell extends UniversalActor  {
	...
	public Cell(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "salsa.Cell", sourceRef);
			  }
	...
	public UniversalActor construct (Object c) {
		Object[] __arguments = { c };
	...
	public class State extends UniversalActor .State {
		...
		public void act(String args[]) {
			Cell c = ((Cell)new Cell(this).construct("hello"));
			{
				Token token_2_0 = new Token();
				// c<-get()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, c, "get", _arguments, null, token_2_0 );
			...
			}
			{
				// c<-set("world")
				{
					...
					Message message = new Message( self, c, "set", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
