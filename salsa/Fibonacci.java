...
public class Fibonacci extends UniversalActor  {
	...
	public Fibonacci(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "salsa.Fibonacci", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "salsa.Fibonacci$State" );
		...
		public int compute() {
			if (n==0) {			return 0;
				...
				Token n1 = new Token("n1");
				{
					// token n1 = fib1<-compute()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, fib1, "compute", _arguments, null, n1 );
						__messages.add( message );
					}
				}
				Token n2 = new Token("n2");
				{
					// token n2 = fib2<-compute()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, fib2, "compute", _arguments, null, n2 );
						__messages.add( message );
					}
				}
				{
